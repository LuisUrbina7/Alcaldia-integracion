...
Route::group(['middleware' => 'auth'], function () {
    ...
    /*  -----rutas Ciudadanos Atendidos---- */
    Route::get('/ciudadanos-atendidos', [CiudadanosController::class, 'index'])->name('ciudadanos');
    Route::post('/ciudadanos-atendidos/crear', [CiudadanosController::class, 'insertar'])->name('ciudadanos.insertar');
    Route::post('/ciudadanos-atendidos/actualizar/insertar/{id}', [CiudadanosController::class, 'actualizar'])->name('ciudadanos.actualizar.insertar');
    Route::get('/ciudadanos-atendidos/borrar/{id}', [CiudadanosController::class, 'borrar'])->name('ciudadanos.borrar')->middleware('adm');
});
