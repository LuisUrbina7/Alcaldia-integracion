            ...
            <div class="row  p-md-4">
                <div class="col-md-9">
                    <div class="d-flex vista-titulo-noticia px-4 align-items-center">
                        ...
                        <div class="p-3">
                            <h3 class="color-oscuro h3 mb-0"> Sintoníza todos los miércoles el programa de radio. </h3>
                            <p> <small class="text-muted "> Autor: Luis Urbina </small> </p>
                        </div>
                    </div>
                    <div class="vista-cuerpo-noticia">
                        <p>Sintoníza todos los miércoles el programa de radio "En Capacho Nuevo con Luis Mendoza" por Radio Nacional de Venezuela (RNV) 105.7 fm desde las 07:00 a.m.  </p>
                            <ul>
                                <li> @FreddyBernal</li>
                                <li>@PSUVTachira</li>
                                <li>@tachira_gmas</li>
                        ...
                        <img src="../img/fijas/prueba-07.jpg" alt="foto" srcset="" width="100%">
