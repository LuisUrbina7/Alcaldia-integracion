            ...
            <div class="row  p-md-4">
                <div class="col-md-9">
                    <div class="d-flex vista-titulo-noticia px-4 align-items-center">
                        ...
                        <div class="p-3">
                            <h3 class="color-oscuro h3 mb-0"> El Alcalde Luis Mendoza realiza dialogo con los comerciantes. </h3>
                            <p> <small class="text-muted "> Autor: Luis Urbina </small> </p>
                        </div>
                    </div>
                    <div class="vista-cuerpo-noticia">
                        <p>El equipo político municipal PSUV, jefes de UBCH, jefes de Comunidad, Líderes de Calle, en Asamblea informativa del método de postulación para los equipos políticos Parroquiales, Municipales y Regionales. 
                        <ul>
                            <li>@NicolasMaduro</li>
                            <li>@BermudezJoseA</li>
                            <li>@tachira_gmas</li>
                        ...
                        <img src="https://pbs.twimg.com/media/Fg7NHyYXwAcYg1P?format=jpg&name=medium" alt="foto" srcset="" width="100%">
